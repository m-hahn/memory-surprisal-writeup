...
\revision{Numerically, we observed that differences in memory and surprisal between real and baseline orders are in the range of up to a few bits, often less than a bit (Figure~\ref{fig:median-table-expt2}).
