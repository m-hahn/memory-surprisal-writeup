...
In the original submission, all logarithms were interpreted as natural logarithms, i.e., using basis $e$. Therefore, the x-axis indicated \emph{nats} of memory (one \emph{nat} equals about $1.44$ \emph{bits}).
