...
We provide an example with analytical calculations in SI Section X \mhahn{and mention that example is not very linguistic}; there we also show that the bounds can be tighter for retrieval-based models.
