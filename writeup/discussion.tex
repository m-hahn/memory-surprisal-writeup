We introduced a notion of memory efficiency in language processing: the memory--surprisal trade-off.
...
This and the other limitations discussed in Section~\ref{sec:baselines} are common to most other order grammar formalisms considered in the literature \citep{gildea-optimizing-2007,futrell2015experiments,wang2016galactic}.
...
The Constant Entropy Rate and Uniform Information Density hypotheses \citep{genzel-entropy-2002,florian-jaeger-redundancy-2010} hold that speakers tend to avoid peaks and troughs in surprisal, arguing that this makes information transmission maximally efficient.
