...
What our results do imply, though, is that real languages provide lower surprisals in the setting of realtively small memory budgets.
...
We provide an example with analytical calculations in SI Section X; there we also show that the bounds can be tighter for retrieval-based models.
