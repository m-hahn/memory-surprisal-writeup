...
\cite{debowski-excess-2011} has studied the excess entropy of language across very long ranges of text, in particular aiming to determine whether it is finite.
Our work contrasts with this work in that we are interested in dependencies within sentences.


\cite{hahn-estimating-2019}

our PNAS paper, mention Zaslavsky et al

refer to MI and distance, Lin and Tegmark

\cite{qian2012cue}

TODO at some point:

- rate-distortion, memory capacity in psychology in general

\cite{brady2009compression} model visual working memory as solving the problem of storing a maximal amount of information given fixed capacity, and provide experimental evidence that visual working memory can store more items when they show stronger statistical patterns in cooccurrence, in accordance with the prediction of optimal encoding.
