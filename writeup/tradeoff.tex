...
\begin{enumerate}
    ...
    \mhahn{at some point make clear that we're not requiring that people actually compute this as a full-fledged distribution. I think we need to say something about the `do people really predict' discussion, and explain why that's orthogonal to our results.}
...
Having defined average surprisal and related concepts, we now turn to the question of how to define memory capacity. The average amount of information stored in the memory states $m_t$ is the entropy of the stationary distribution over memory states, $H_M$: \mhahn{people might not know what `stationary distribution' means}
\begin{align}
