So far, we have proven that there exists a trade-off between memory invested and surprisal incurred during language processing, and that this trade-off is optimized when languages have relatively short-term dependencies. In this section we qualitatively illustrate the linguistic predictions of our theoretical results \jd{instead: "qualitatively test the Efficient Tradeoff Curve Hypothesis"?}  by reanalyzing the data from \cite{fedzechkina-human-2017}.
