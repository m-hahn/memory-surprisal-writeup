...
All four languages have strong word order freedom, as we will see below in Figure~\ref{fig:freedom-surp} \mhahn{(also CITE something)}.
...
A second possibility is that languages with seemingly free word order encode other information in word order, in particular, information about information structure \citep[e.g.]{givon1988pragmatics,firbas1966,definingfirbas1974aspects,myhill1985pragmatic}.
