...
We formalize the notion of memory constraints in terms of what we call the \key{memory--surprisal trade-off}: the idea that the ease of comprehension depends on the amount of computational resources invested into remembering previous linguistic elements, e.g., words. 
...
Using this concept, we introduce the \key{Efficient Tradeoff Curve Hypothesis}: Order in natural language is structured so as to provide efficient memory-surprisal tradeoff curves.
