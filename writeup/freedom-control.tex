...
In this section we address the question about word order freedom raised in Section~\ref{subsec:expt2-discussion}.
...
\definecolor{baselineInfo}{HTML}{00F9DE}
\definecolor{baseline}{HTML}{7CAE00}
\definecolor{real}{HTML}{C77CFF}
...
\textbf{\textcolor{baselineInfo}{----}} Baselines with Information Structure
\end{tabular}
\end{center}
