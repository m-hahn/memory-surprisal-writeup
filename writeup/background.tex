...
While NP objects ordinarily precede PPs (\ref{ex:heavy-np-1}), this order is less preferred when the NP is very long (\ref{ex:heavy-np-2}), in which case the inverse order becomes more felicitous (\ref{ex:heavy-np-3}).
The pattern in (\ref{ex:heavy-np-3}) is known as Heavy NP Shift.
...
%https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1615890/pdf/nihms10460.pdf

% Ross,1967; but cf. Kayne, 1998; Rochemont & Culicover, 1997)

Example from https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1615890/pdf/nihms10460.pdf
...
% https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3085651/pdf/nihms265242.pdf
% http://citeseer.ist.psu.edu/viewdoc/download;jsessionid=8871C63972613516105B2C96A20F4EAE?doi=10.1.1.100.8375&rep=rep1&type=pdf
