...
\begin{reply}
We have carefully thought about methods that could be moved into the SI. We decided to keep all methods in the main paper, as every one of the subsections in Study 2 seems relevant to understanding the experiment and results, and the minor details are already in SI Section 3.2-3.5.
\end{reply}
...
\begin{reply}
	We have added the sentence \emph{We
