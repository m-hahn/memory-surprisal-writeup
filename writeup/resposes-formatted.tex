...
We have added the missing axis labels. \mhahn{TODO do this}
	...
	While 1 bit of memory seems like a small difference, it is important that this is a difference in the per-word cost at every word, which accumulates over a sentence. \mhahn{do we have to say something in the paper?}
\end{reply}
...
\begin{reply}
	TODO point to retrieval bounds, maybe we can make this a bit more prominent. Point to the discussion on `Cue-Based Retrieval Models' in the General Discussion.
\end{reply}
